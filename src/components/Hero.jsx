...
const HERO_VIDEO_DESKTOP = '/videos/hero-desktop.mp4'; // 1080p ~6 MB
const HERO_VIDEO_MOBILE = '/videos/hero-mobile.mp4';   // 720p ~2 MB

const BADGES = [
  { icon: '★', label: '4,9 / 5', sub: '87 avis Google' },
  { icon: '✦', label: 'Bio', sub: 'Tomate des Pouilles' },
  { icon: '✓', label: 'Maison', sub: 'Pâte travaillée 48h' },
  { icon: '⌂', label: 'Local', sub: 'Producteurs du Comminges' },
];
    ...
    <section ref={ref} className="z-hero" id="accueil">
      <motion.div className="z-hero-video-wrap" style={{ y: videoY }}>
        <video
          ...
          poster={HERO_POSTER}
        >
          <source src={HERO_VIDEO_MOBILE} type="video/mp4" media="(max-width: 768px)" />
